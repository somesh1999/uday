 ...
 */
public class InstanceChooserList6 extends InstanceListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceChooserList6.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (editMode) {
            return new InstancesDao().getUnsentInstancesCursorLoader6(getFilterText(), getSortingOrder());
        } else {
