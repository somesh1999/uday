...
public class InstanceUploaderList11 extends InstanceListActivity implements
    ...
    private static final String INSTANCE_UPLOADER_LIST_SORTING_ORDER = "InstanceUploaderList11SortingOrder";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceUploaderList11.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (showAllMode) {
            return instancesDao.getUnsentInstancesCursorLoader11(getFilterText(), getSortingOrder());
        } else {
            return instancesDao.getUnsentInstancesCursorLoader11(getFilterText(), getSortingOrder());
        }
    }
