...
public class FileManagerTabs9 extends CollectAbstractActivity {

    private final DataManagerList9 dataManagerList9 = DataManagerList9.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList9);
