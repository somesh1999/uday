...
public class FileManagerTabs8 extends CollectAbstractActivity {

    private final DataManagerList8 dataManagerList8 = DataManagerList8.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList8);
