 ...
 */
public class DataManagerList11 extends InstanceListFragment
        implements DeleteInstancesListener, DiskSyncListener, View.OnClickListener {
    private static final String DATA_MANAGER_LIST_SORTING_ORDER = "DataManagerList11SortingOrder";
    ...
    public static DataManagerList11 newInstance() {
        return new DataManagerList11();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader11(getFilterText(), getSortingOrder());
    }
