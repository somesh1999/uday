...
public class InstanceUploaderList6 extends InstanceListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceUploaderList6.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (showAllMode) {
            return instancesDao.getUnsentInstancesCursorLoader6(getFilterText(), getSortingOrder());
        } else {
            return instancesDao.getUnsentInstancesCursorLoader6(getFilterText(), getSortingOrder());
        }
    }
