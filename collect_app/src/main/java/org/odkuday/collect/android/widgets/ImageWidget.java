...
import org.odkuday.collect.android.activities.CaptureSelfieActivity;
import org.odkuday.collect.android.activities.CaptureSelfieActivityNewApi;
...
public class ImageWidget extends BaseImageWidget {
    ...
    public ImageWidget(Context context, final FormEntryPrompt prompt) {
        ...
        prefs = context.getSharedPreferences("image_pref", MODE_PRIVATE);
        formname = prefs.getString("formname", null);
        setUpLayout();
        setUpBinary();
    ...
    protected void setUpLayout() {
        ...
        prefs = getContext().getSharedPreferences("image_pref", MODE_PRIVATE);
        String form = prefs.getString("formname", null);
