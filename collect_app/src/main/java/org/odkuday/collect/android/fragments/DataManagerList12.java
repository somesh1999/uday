 ...
 */
public class DataManagerList12 extends InstanceListFragment
        implements DeleteInstancesListener, DiskSyncListener, View.OnClickListener {
    private static final String DATA_MANAGER_LIST_SORTING_ORDER = "DataManagerList12SortingOrder";
    ...
    public static DataManagerList12 newInstance() {
        return new DataManagerList12();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader12(getFilterText(), getSortingOrder());
    }
