 ...
 */
public class DataManagerList5 extends InstanceListFragment
    ...
    public static DataManagerList5 newInstance() {
        return new DataManagerList5();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader5(getFilterText(), getSortingOrder());
    }
