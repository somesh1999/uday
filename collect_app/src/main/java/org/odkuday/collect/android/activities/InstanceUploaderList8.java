...
public class InstanceUploaderList8 extends InstanceListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceUploaderList8.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (showAllMode) {
            return instancesDao.getUnsentInstancesCursorLoader8(getFilterText(), getSortingOrder());
        } else {
            return instancesDao.getUnsentInstancesCursorLoader8(getFilterText(), getSortingOrder());
        }
    }
