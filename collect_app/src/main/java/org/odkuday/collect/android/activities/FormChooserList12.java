...
import org.odkuday.collect.android.tasks.DiskSyncTask;
import org.odkuday.collect.android.utilities.ApplicationConstants;
import org.odkuday.collect.android.utilities.FormUtils;
import org.odkuday.collect.android.utilities.VersionHidingCursorAdapter;
 ...
 */
public class FormChooserList12 extends FormListActivity implements
        DiskSyncListener, AdapterView.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    private static final String FORM_CHOOSER_LIST_SORTING_ORDER = "FormChooserList12SortingOrder";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(FormChooserList12.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        return new FormsDao().getFormsCursorLoader12(getFilterText(), getSortingOrder());
    }
