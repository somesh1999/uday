...
import org.odkuday.collect.android.listeners.DeleteInstancesListener;
...
import org.odkuday.collect.android.tasks.DeleteInstancesTask;
 ...
 */
public class DataManagerList10 extends InstanceListFragment
        implements DeleteInstancesListener, DiskSyncListener, View.OnClickListener {
    private static final String DATA_MANAGER_LIST_SORTING_ORDER = "DataManagerList10SortingOrder";
    ...
    public static DataManagerList10 newInstance() {
        return new DataManagerList10();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader10(getFilterText(), getSortingOrder());
    }
