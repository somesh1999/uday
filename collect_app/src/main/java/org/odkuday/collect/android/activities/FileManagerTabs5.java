...
public class FileManagerTabs5 extends CollectAbstractActivity {

    private final DataManagerList5 dataManagerList5 = DataManagerList5.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList5);
