 ...
 */
public class DataManagerList4 extends InstanceListFragment
    ...
    public static DataManagerList4 newInstance() {
        return new DataManagerList4();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader4(getFilterText(), getSortingOrder());
    }
