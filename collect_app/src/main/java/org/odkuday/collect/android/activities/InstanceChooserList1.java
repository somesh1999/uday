 ...
 */
public class InstanceChooserList1 extends InstanceListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceChooserList1.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (editMode) {
            return new InstancesDao().getUnsentInstancesCursorLoader1(getFilterText(), getSortingOrder());
        } else {
