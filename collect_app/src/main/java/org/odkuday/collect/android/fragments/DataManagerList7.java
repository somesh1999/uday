 ...
 */
public class DataManagerList7 extends InstanceListFragment
    ...
    public static DataManagerList7 newInstance() {
        return new DataManagerList7();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader7(getFilterText(), getSortingOrder());
    }
