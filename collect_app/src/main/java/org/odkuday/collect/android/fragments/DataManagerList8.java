 ...
 */
public class DataManagerList8 extends InstanceListFragment
    ...
    public static DataManagerList8 newInstance() {
        return new DataManagerList8();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader8(getFilterText(), getSortingOrder());
    }
