 ...
 */
public class DataManagerList6 extends InstanceListFragment
    ...
    public static DataManagerList6 newInstance() {
        return new DataManagerList6();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader6(getFilterText(), getSortingOrder());
    }
