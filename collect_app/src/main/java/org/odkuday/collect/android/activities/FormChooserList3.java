 ...
 */
public class FormChooserList3 extends FormListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(FormChooserList3.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        return new FormsDao().getFormsCursorLoader3(getFilterText(), getSortingOrder());
    }
