...
public class InstanceUploaderList12 extends InstanceListActivity implements
    ...
    private static final String INSTANCE_UPLOADER_LIST_SORTING_ORDER = "InstanceUploaderList12SortingOrder";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceUploaderList12.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (showAllMode) {
            return instancesDao.getUnsentInstancesCursorLoader12(getFilterText(), getSortingOrder());
        } else {
            return instancesDao.getUnsentInstancesCursorLoader12(getFilterText(), getSortingOrder());
        }
    }
