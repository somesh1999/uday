 ...
 */
public class DataManagerList2 extends InstanceListFragment
    ...
    public static DataManagerList2 newInstance() {
        return new DataManagerList2();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader2(getFilterText(), getSortingOrder());
    }
