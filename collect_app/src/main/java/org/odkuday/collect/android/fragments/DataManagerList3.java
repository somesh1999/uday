 ...
 */
public class DataManagerList3 extends InstanceListFragment
    ...
    public static DataManagerList3 newInstance() {
        return new DataManagerList3();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader3(getFilterText(), getSortingOrder());
    }
