...
import org.odkuday.collect.android.BuildConfig;
import org.odkuday.collect.android.R;
import org.odkuday.collect.android.adapters.IconMenuListAdapter;
import org.odkuday.collect.android.adapters.model.IconMenuItem;
import org.odkuday.collect.android.application.Collect;
import org.odkuday.collect.android.dao.FormsDao;
import org.odkuday.collect.android.dao.helpers.ContentResolverHelper;
import org.odkuday.collect.android.dao.helpers.FormsDaoHelper;
import org.odkuday.collect.android.dao.helpers.InstancesDaoHelper;
import org.odkuday.collect.android.exception.GDriveConnectionException;
import org.odkuday.collect.android.exception.JavaRosaException;
import org.odkuday.collect.android.external.ExternalDataManager;
import org.odkuday.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.odkuday.collect.android.fragments.dialogs.NumberPickerDialog;
import org.odkuday.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.odkuday.collect.android.listeners.AdvanceToNextListener;
import org.odkuday.collect.android.listeners.FormLoaderListener;
import org.odkuday.collect.android.listeners.FormSavedListener;
import org.odkuday.collect.android.listeners.PermissionListener;
import org.odkuday.collect.android.listeners.SavePointListener;
import org.odkuday.collect.android.logic.FormController;
import org.odkuday.collect.android.logic.FormController.FailedConstraint;
import org.odkuday.collect.android.logic.FormInfo;
...
import org.odkuday.collect.android.provider.FormsProviderAPI.FormsColumns;
import org.odkuday.collect.android.provider.InstanceProviderAPI.InstanceColumns;
import org.odkuday.collect.android.tasks.FormLoaderTask;
import org.odkuday.collect.android.tasks.SaveFormIndexTask;
import org.odkuday.collect.android.tasks.SavePointTask;
import org.odkuday.collect.android.tasks.SaveResult;
import org.odkuday.collect.android.tasks.SaveToDiskTask;
import org.odkuday.collect.android.utilities.ActivityAvailability;
import org.odkuday.collect.android.utilities.ApplicationConstants;
import org.odkuday.collect.android.utilities.DependencyProvider;
import org.odkuday.collect.android.utilities.DialogUtils;
import org.odkuday.collect.android.utilities.FileUtils;
import org.odkuday.collect.android.utilities.ImageConverter;
import org.odkuday.collect.android.utilities.MediaManager;
import org.odkuday.collect.android.utilities.MediaUtils;
import org.odkuday.collect.android.utilities.SoftKeyboardUtils;
import org.odkuday.collect.android.utilities.TimerLogger;
import org.odkuday.collect.android.utilities.ToastUtils;
import org.odkuday.collect.android.views.ODKView;
import org.odkuday.collect.android.widgets.DateTimeWidget;
import org.odkuday.collect.android.widgets.QuestionWidget;
import org.odkuday.collect.android.widgets.RangeWidget;
import org.odkuday.collect.android.widgets.StringWidget;
...
import static org.odkuday.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.odkuday.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.odkuday.collect.android.utilities.PermissionUtils.checkIfStoragePermissionsGranted;
...
public class FormEntryActivity extends CollectAbstractActivity implements AnimationListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*SharedPreferences prefs = getSharedPreferences("image_pref", MODE_PRIVATE);
        String formname = prefs.getString("formname", null);
        Toast.makeText(this, ""+formname, Toast.LENGTH_SHORT).show();*/


        save_form=(Button)findViewById(R.id.save_form);
        save_form.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                FormController formController = getFormController();
                String formname=formController.getFormTitle();
              //  Toast.makeText(FormEntryActivity.this, "You have successfully saved "+formname, Toast.LENGTH_SHORT).show();
                saveDataToDisk(EXIT, InstancesDaoHelper.isInstanceComplete(true), formname);
                if(formname=="Volunteer"){
                    Intent i=new Intent(getBaseContext(),FormChooserList.class);
                    startActivity(i);
                }
                else if(formname=="Facilitator"){
                    Intent i=new Intent(getBaseContext(),FormChooserList1.class);
                    startActivity(i);
                }
                else if(formname=="District Coordinator"){
                    Intent i=new Intent(getBaseContext(),FormChooserList2.class);
                    startActivity(i);
                }
                else if(formname=="State Coordinator"){
                    Intent i=new Intent(getBaseContext(),FormChooserList3.class);
                    startActivity(i);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_preferences:
                ...
                //startActivity(pref);
                Toast.makeText(this, "Not Accessible", Toast.LENGTH_SHORT).show();
                return true;
        }
        ...
        switch (event) {
            ...
            case FormEntryController.EVENT_END_OF_FORM:
               /* View endView = View.inflate(this, R.layout.form_entry_end, null);
                ...
                return endView;*/
                return createViewForFormEnd(event, false, formController);
    ...
    private View createViewForFormEnd(int event, boolean advancingPage,
                                            FormController formController) {
        try {
            event = formController.stepToPreviousScreenEvent();
            nextButton.setVisibility(View.GONE);
            save_form.setVisibility(View.VISIBLE);
    ...
    private void showNextView() {
        ...
        try {
            ...
            if(title.equals("Volunteer / Pragatisathi")){
                if(nextmove==4 || nextmove==0) {
                    save_form.setVisibility(View.VISIBLE);
                    nextButton.setVisibility(View.GONE);
                }
            ...
            if(title.equals("State PMU Uday") ||title.equals("District Coordinator") || title.equals("Regional Coordinator") || title.equals("Cluster Coordinator")){
            if(nextmove==3 || nextmove==0) {
                save_form.setVisibility(View.VISIBLE);
                nextButton.setVisibility(View.GONE);
            }
    ...
    private void sendSavedBroadcast() {
        sendBroadcast(new Intent("org.odkuday.collect.android.FormSaved"));
    }
