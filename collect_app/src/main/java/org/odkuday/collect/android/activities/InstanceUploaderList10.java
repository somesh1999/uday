...
public class InstanceUploaderList10 extends InstanceListActivity implements
    ...
    private static final String INSTANCE_UPLOADER_LIST_SORTING_ORDER = "InstanceUploaderList10SortingOrder";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceUploaderList10.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (showAllMode) {
            return instancesDao.getUnsentInstancesCursorLoader10(getFilterText(), getSortingOrder());
        } else {
            return instancesDao.getUnsentInstancesCursorLoader10(getFilterText(), getSortingOrder());
        }
    }
