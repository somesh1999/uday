...
public class FileManagerTabs3 extends CollectAbstractActivity {

    private final DataManagerList3 dataManagerList3 = DataManagerList3.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList3);
