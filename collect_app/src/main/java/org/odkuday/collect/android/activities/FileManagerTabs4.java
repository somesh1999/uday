...
public class FileManagerTabs4 extends CollectAbstractActivity {

    private final DataManagerList4 dataManagerList4 = DataManagerList4.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList4);
