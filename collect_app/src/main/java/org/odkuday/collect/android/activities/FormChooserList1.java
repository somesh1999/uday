 ...
 */
public class FormChooserList1 extends FormListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(FormChooserList1.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        return new FormsDao().getFormsCursorLoader1(getFilterText(), getSortingOrder());
    }
