...
public class FileManagerTabs7 extends CollectAbstractActivity {

    private final DataManagerList7 dataManagerList7 = DataManagerList7.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList7);
