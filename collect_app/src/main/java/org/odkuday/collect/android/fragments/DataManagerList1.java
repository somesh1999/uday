 ...
 */
public class DataManagerList1 extends InstanceListFragment
    ...
    public static DataManagerList1 newInstance() {
        return new DataManagerList1();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader1(getFilterText(), getSortingOrder());
    }
