 ...
 */
public class DataManagerList9 extends InstanceListFragment
        implements DeleteInstancesListener, DiskSyncListener, View.OnClickListener {
    private static final String DATA_MANAGER_LIST_SORTING_ORDER = "DataManagerList9SortingOrder";
    ...
    public static DataManagerList9 newInstance() {
        return new DataManagerList9();
    }
    ...
    protected CursorLoader getCursorLoader() {
        return new InstancesDao().getSavedInstancesCursorLoader9(getFilterText(), getSortingOrder());
    }
