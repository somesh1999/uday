 ...
 */
public class visit_hq extends CollectAbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visit_hq);
        initToolbar();
        ...
        volunteer.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(getBaseContext(),MainMenuActivity9.class);  // main menu activity 4
                startActivity(i);
            }
        });
        ...
        facilitator.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getBaseContext(),MainMenuActivity10.class);
                startActivity(i);
            }
        });
        ...
        districtCoordinator.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getBaseContext(),MainMenuActivity11.class);
                startActivity(i);
            }
        });
        ...
        stateCoordinator.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getBaseContext(),MainMenuActivity12.class);
                startActivity(i);
            }
        });
