...
public class FileManagerTabs6 extends CollectAbstractActivity {

    private final DataManagerList6 dataManagerList6 = DataManagerList6.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList6);
