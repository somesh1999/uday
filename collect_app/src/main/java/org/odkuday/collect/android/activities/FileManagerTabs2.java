...
public class FileManagerTabs2 extends CollectAbstractActivity {

    private final DataManagerList2 dataManagerList2 = DataManagerList2.newInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(dataManagerList2);
