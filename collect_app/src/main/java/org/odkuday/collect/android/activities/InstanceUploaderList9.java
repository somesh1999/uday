...
public class InstanceUploaderList9 extends InstanceListActivity implements
    ...
    private static final String INSTANCE_UPLOADER_LIST_SORTING_ORDER = "InstanceUploaderList9SortingOrder";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        requestStoragePermissions(this, new PermissionListener() {
            ...
            public void denied() {
                ...
                finishAllActivities(InstanceUploaderList9.this);
            }
        });
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        showProgressBar();
        if (showAllMode) {
            return instancesDao.getUnsentInstancesCursorLoader9(getFilterText(), getSortingOrder());
        } else {
            return instancesDao.getUnsentInstancesCursorLoader9(getFilterText(), getSortingOrder());
        }
    }
